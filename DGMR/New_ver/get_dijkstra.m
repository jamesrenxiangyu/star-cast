%% GPCA: Original Dijkstra using logarithm of time and pdr as edge cost

function [Cost, Route] = get_dijkstra( Graph, SourceNode, TerminalNode )
...
if TerminalNode > size(PathToNode,1)
    TerminalNode
    size(PathToNode,1)
    TerminalNode = size(PathToNode,1);
    warning('TerminalNode larger than graph!');
end

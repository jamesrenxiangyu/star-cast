function [PDR, deltaSEN, deltaPRO, deltaCOL, CBR] = pdr_cal(Ch_par, Rate, Distance)
...
%     if exist(file1,'file')
%         legend('PRO sim' , 'SEN sim','PRO analit' , 'COL analit' , 'RXB analit', 'SEN analit','location','northwest')    
%     else
%         legend('PRO analit' , 'SEN analit','location','northwest')            
%     end    
% 
